...
const TRANSLATIONS = [
    'nl' => [
        ...
        'moirai.placeholder.search' => 'Naam, model, serienummer, IMEI, gebruiker…',
        ...
        'moirai.error.screen_invalid' => 'Schermformaat moet een getal in inches zijn.',
    ...
    'en' => [
        ...
        'moirai.label.status' => 'Status',
        'moirai.placeholder.search' => 'Name, model, serial, IMEI, user…',
        ...
        'moirai.error.screen_invalid' => 'Screen size must be a number in inches.',
    ...
    'de' => [
        ...
        'moirai.label.status' => 'Status',
        'moirai.placeholder.search' => 'Name, Modell, Seriennummer, IMEI, Benutzer…',
        ...
        'moirai.error.screen_invalid' => 'Bildschirmgröße muss eine Zahl in Zoll sein.',
    ...
    'fr' => [
        ...
        'moirai.placeholder.search' => 'Nom, modèle, n° série, IMEI, utilisateur…',
        ...
        'moirai.error.screen_invalid' => 'La taille d\'écran doit être un nombre en pouces.',
