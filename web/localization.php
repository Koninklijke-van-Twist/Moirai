...
const TRANSLATIONS = [
    'nl' => [
        ...
        'moirai.error.print_unavailable' => 'QR-code bibliotheek niet geladen. Vernieuw de pagina.',
        'moirai.error.print_barcode' => 'QR-code kon niet worden gegenereerd.',
        'moirai.print.bridge_fallback' => 'Print-bridge niet bereikbaar. Via de browser printen?',
    ...
    'en' => [
        ...
        'moirai.error.print_unavailable' => 'QR code library not loaded. Refresh the page.',
        'moirai.error.print_barcode' => 'Could not generate QR code.',
        'moirai.print.bridge_fallback' => 'Print bridge unavailable. Print via browser instead?',
    ...
    'de' => [
        ...
        'moirai.error.print_unavailable' => 'QR-Code-Bibliothek nicht geladen. Seite neu laden.',
        'moirai.error.print_barcode' => 'QR-Code konnte nicht erzeugt werden.',
        'moirai.print.bridge_fallback' => 'Print-Bridge nicht erreichbar. Stattdessen über den Browser drucken?',
    ...
    'fr' => [
        ...
        'moirai.error.print_unavailable' => 'Bibliothèque QR code non chargée. Actualisez la page.',
        'moirai.error.print_barcode' => 'Impossible de générer le QR code.',
        'moirai.print.bridge_fallback' => 'Pont d\'impression indisponible. Imprimer via le navigateur ?',
